...
namespace Util
{
	void TwoOnFrontTriangle::MakeTriangles()
	{
		...
		m_frontIndexBuffer->indices.push_back(1);//残りの頂点の1つめ(TODO:後から変更、新頂点の2つ目になるかな?)
		...
		m_frontIndexBuffer->indices.push_back(2);//残りの頂点の2つめ(TODO:後から変更、frontIndexesのうちm_diagonalじゃない方になりそう)
